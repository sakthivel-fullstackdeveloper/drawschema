...
import { register, googleLogin, verifyOtp, resendOtp } from '../../services/auth';
          ...
          <>
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-lg text-sm font-semibold transition duration-150 shadow-lg shadow-indigo-600/20 flex items-center justify-center"
              >
                {loading ? 'Verifying OTP...' : 'Complete Sign Up'}
              </button>
            </form>
